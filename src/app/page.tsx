  ...
  return (
    <div className="liquid-bg min-h-screen">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        {/* Call Button */}
        <a
          href={`tel:${RETELL_PHONE_NUMBER}`}
          className="flex items-center gap-3 bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white px-5 py-4 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-105"
        >
          <Phone className="w-6 h-6" />
          <span className="hidden sm:block font-semibold">Llama al AI</span>
        </a>
        ...
        <a
          ...
          className="flex items-center gap-3 bg-[#25D366] hover:bg-[#128C7E] text-white px-5 py-4 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-105 relative"
        >
          ...
          <span className="hidden sm:block font-semibold">WhatsApp AI</span>
